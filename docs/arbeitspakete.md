...
> 0010 Medien; 0008 Indizes und 0009 Rollen aus den Vorarbeiten) laufen einzeln über `/ap`. Maßgeblich ist `.claude/commands/kette-ui.md`.
...
**Migration 0010 — fünf neue Tabellen, Spaltenerweiterungen und eine CHECK-Erweiterung**
| Was | Warum |
|---|---|
