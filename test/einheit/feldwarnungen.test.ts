...
describe('feldZielFuer() — Zuordnung Hinweiscode → Reiter/Feld', () => {
  it('die Codeliste nennt genau die acht Bestandsregeln', () => {
    expect([...BESTAND_HINWEIS_CODES].sort()).toEqual(
      ['alter_ueber_110', 'bestattung_vor_tod', 'ereignis_vor_ortsexistenz', 'kind_vor_ehe', 'mutter_alter', 'tod_vor_geburt', 'vater_alter', 'zyklus'],
    )
  })
