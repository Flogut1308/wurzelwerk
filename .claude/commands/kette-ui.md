...
**Kette 2** (`/kette-ui 2`): AP-1.26 → AP-1.27 → AP-1.12 → AP-1.13 → AP-1.14 → AP-1.15 → AP-1.16 → AP-1.17
  AP-1.26 zuerst: der Eingang der App (die Startansicht ist der einzige ungestaltete Bildschirm,
