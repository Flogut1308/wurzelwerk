// AP-0.9 (F-01, ADR-009 Punkt 2) — reine Zyklusfreiheits-Funktion für den Elternschaftsgraphen.
// Vorbereitung für den späteren Elternkanten-Befehl (AP-0.10+): den Befehl, der eine Elternkante
// setzt, gibt es noch nicht - diese Datei liefert nur die reine Prüf-Funktion, die er dann nutzt.
// Die fachliche Invariante „niemand ist eigener Vorfahre" (fast-check) liegt getrennt in
// test/invarianten/zyklusfreiheit.test.ts (geschützter Prüfpfad, ADR-025 → eigener PR).
//
